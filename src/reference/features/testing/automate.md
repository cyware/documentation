...
Advanced setting options ensure your campaign can account for events such as failed requests or rate-limiting. You can transfer requests to the Automate interface from many other Cyware interfaces.
...
1. Select the `Automate` tab from the left-hand menu within the Cyware window.
...
Cyware currently provides the following attack `Strategies`:
...
- **Hosted File:** This allows you to select one of the files you had previously uploaded to the Cyware Instance. View the [Files](/reference/features/workspace/files.md) documentation for more information.
