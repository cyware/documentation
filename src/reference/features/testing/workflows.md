...
Incorporating **Workflows** into your methodology greatly extends the functionality of Cyware. The level of customization offered by Cyware Workflows allows you to  repeatedly apply certain actions/conversions that are commonly used in your testing process. Anything from encoding data to complex sequences of modifications based on certain conditions by utilizing flow paths are possible with Workflows.
...
1. Select the `Workflows` tab from the left-hand menu within the Cyware window.
...
7. Clicking on `Community Workflows` will open a browser window to <a href="https://github.com/cyware/workflows" target="_blank">Cyware's Workflow Github Repository</a>. Here you can download Workflows created by other Cyware users or submit your own!
...
9. `Import` allows you to select downloaded Workflows to use in your Cyware instance.
